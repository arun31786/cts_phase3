...
//	http://localhost:8080/BaseCodeSlice_MyAssessmentApplication/mvc/i18nPage?language=
	...
	public String getI18n(@RequestParam("language") String language, Model model){
        ...
        String welcome = messageSource.getMessage("welcome", new Object[]{"Carl Mark"}, newLocale);
